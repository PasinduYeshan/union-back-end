...
const _updateBranchSecretary: Handler = async (req, res) => {
  ...
  const [error, response] = await model.web.update_BranchSecretary(branchSecId, data);
...
const _updateCommitteeMember: Handler = async (req, res) => {
  ...
  const [error, response] = await model.web.update_CommitteeMember(committeeMemberId, data);
 ...
 */
export const updateBranchSecretary = [branchSecretaryInspector, <EHandler>_updateBranchSecretary];
export const updateCommitteeMember = [committeeMemberInspector, <EHandler>_updateCommitteeMember];
